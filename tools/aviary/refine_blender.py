...
for sid,span in SPECS:
    ...
    ob.location=rig.location;ob['asset_role']='game_mesh';ob['concept_reference']=str(ROOT/'assets-src/aviary'/({'pearl-gull':'pearl','lagoon-jay':'lagoon','ember-kestrel':'ember'}[sid]+'-reference-v2.png'))
