...
const PROBE_INIT = `(() => {
  // Idle-economy probe: start from a known mixer so a leftover localStorage
  // mix cannot keep a bus audible and spoil the suspend assertions.
  try {
    localStorage.setItem("sf-audio", JSON.stringify({
      schema: 2, musicVolume: 0.42, effectsVolume: 0.68,
