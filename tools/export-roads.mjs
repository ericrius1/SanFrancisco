#!/usr/bin/env node
/**
 * Build-time road exporter for the runtime road graph.
 *
 ...
 *
 * We drop bridge segments (bridge === true) because the road graph covers the
 * street grid rather than modelled spans, and footpaths (w < 6). Coordinates
 * are quantised to 0.1 m ints (world metres ×10) to keep the file small;
 * RoadGraph divides back by 10.
 *
 * Output shape (v4):
 *   { v: 4, segs: [
 *       { p: [x1,z1, x2,z2, ...] (×10 ints), w, d: onewayDir, k: class }
 *   ] }
 *
