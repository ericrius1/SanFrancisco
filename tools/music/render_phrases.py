...
PHRASES = [
    ...
    ("drift-bright", "bright", "rhodes",
     [(0.0, 2, 0.55), (1.4, 4, 0.6), (2.2, 5, 0.45), (3.0, 7, 0.62), (5.2, 5, 0.4)]),
    ("high-bright", "bright", "rhodes",
     [(0.0, 9, 0.5), (0.8, 7, 0.55), (2.2, 5, 0.42), (4.0, 6, 0.5)]),
    ("step-bright", "bright", "rhodes",
     [(0.0, 0, 0.6), (1.1, 2, 0.5), (2.2, 1, 0.44), (3.3, 4, 0.58), (4.4, 2, 0.4), (5.6, 0, 0.5)]),
    ("swell2-bright", "bright", "ks",
     [(0.0, 2, 0.7), (2.0, 4, 0.6), (3.8, 7, 0.72)]),
