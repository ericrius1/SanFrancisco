...
import { createRoadMarkings } from "../../world/roadMarkings.ts";
...
export class AiCars {
  ...
  async ready(): Promise<void> {
    ...
    void createRoadMarkings(this.#scene, this.#map).catch((err: unknown) => console.warn("[roads] lane markings unavailable", err));
