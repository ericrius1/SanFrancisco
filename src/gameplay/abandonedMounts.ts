...
// pixels at most while still costing draws — hide the mesh and let the body
// sleep. This also subsumes the older sky-flicker fix (a drawn-yet-fogged far
// vessel could flash mid-sky on a corrupted frame; an unrendered one cannot).
