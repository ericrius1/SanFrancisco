...
export const SURF_CAMERA_TUNING = tunables("camera.surf", {
  ...
  distance: { v: 6.25, min: 3, max: 18, step: 0.25, label: "chase distance" },
  height: { v: 2.65, min: 0.6, max: 10, step: 0.1, label: "camera height" },
  // 0 = pure down-line chase, 1 = square-on at the wave face.
  waveLook: { v: 0.18, min: 0.05, max: 0.95, step: 0.01, label: "face-on look blend" },
  ...
  targetHeight: { v: 1.25, min: 0.4, max: 4, step: 0.05, label: "aim height" },
