...
export const SURF_CAMERA_TUNING = tunables("camera.surf", {
  distance: { v: 7.5, min: 3, max: 14, step: 0.25, label: "trail distance" },
  height: { v: 3.8, min: 1.8, max: 8, step: 0.1, label: "camera height" },
  shoreOffset: { v: 8.5, min: 3, max: 16, step: 0.25, label: "shore offset" },
  lookAhead: { v: 4.5, min: 0, max: 10, step: 0.25, label: "line look-ahead" },
  targetHeight: { v: 1.15, min: 0.3, max: 3, step: 0.05, label: "aim height" },
  ...
  waterClearance: { v: 1.25, min: 0.5, max: 3, step: 0.05, label: "water clearance" },
