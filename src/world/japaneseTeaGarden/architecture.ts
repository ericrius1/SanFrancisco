...
// Extension-less loadTexture() names: KTX2 (GPU-compressed) with WebP fallback,
// both generated by tools/optimize-textures.mjs. The KTX2 is encoded lower-left
// so it samples upright exactly like the flipY=true WebP fallback.
const TEA_HOUSE_ART = [
  "/art/tea-house/misty-pines",
  "/art/tea-house/drum-bridge-moon",
  "/art/tea-house/koi-ginkgo",
