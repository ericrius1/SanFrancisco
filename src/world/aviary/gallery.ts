...
(document.getElementById('motion') as HTMLSelectElement).onchange = e => viewer?.setAnimation((e.target as HTMLSelectElement).value as 'Auto' | 'Fly' | 'Glide' | 'Scatter' | 'Perch');
