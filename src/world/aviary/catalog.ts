...
export const BIRD_SPECIES = [
  { id: 'pearl-gull', name: 'Pearl', subtitle: 'Coastal gull', color: '#dbe9e6', speed: 9.5, scale: .72 },
  { id: 'lagoon-jay', name: 'Lagoon', subtitle: 'Crested jay', color: '#49cdc6', speed: 7.2, scale: .65 },
  { id: 'ember-kestrel', name: 'Ember', subtitle: 'Copper kestrel', color: '#eda66b', speed: 11, scale: .7 },
] as const;
